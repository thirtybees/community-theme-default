$(function() {
    ...
    // Temp solution for RTL cause position option isn't working.
    var searchBtnSize = $('#searchbox').find('.input-group-btn').width() + 10;
    var blockWidth = $input.parents('form').outerWidth() - searchBtnSize;
